...
print("PowerShell script 'download_kitti_separate_windows.ps1' has been successfully generated.")

print("Run download_kitti_separate_windows.ps1 and dont use ur pc for some time ")