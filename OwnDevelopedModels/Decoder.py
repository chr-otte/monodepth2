...
class Decoder(nn.Module):
    def __init__(self, num_output_channels=1):
        ...
        self.conv5 = nn.Conv2d(512, 256, kernel_size=3, padding=1)  # 512 = 256 + 256 (skip)

        self.upconv4 = nn.Conv2d(256, 128, kernel_size=3, padding=1)
        self.bn4 = nn.BatchNorm2d(128)
        self.conv4 = nn.Conv2d(256, 128, kernel_size=3, padding=1)  # 256 = 128 + 128 (skip)

        self.upconv3 = nn.Conv2d(128, 64, kernel_size=3, padding=1)
        self.bn3 = nn.BatchNorm2d(64)
        self.conv3 = nn.Conv2d(128, 64, kernel_size=3, padding=1)  # 128 = 64 + 64 (skip)

        self.upconv2 = nn.Conv2d(64, 32, kernel_size=3, padding=1)
        self.bn2 = nn.BatchNorm2d(32)
        self.conv2 = nn.Conv2d(96, 32, kernel_size=3, padding=1)  # 96 = 32 + 64 (skip)
    ...
    def forward(self, x, skip_connections):
        ...
        x = torch.cat([x, skip_connections['layer3']], dim=1)
