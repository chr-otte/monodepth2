...
def get_experiment_config(i):
    if i == 0:
        ...
        depth_net = DepthNetbase()  # Use your baseline model
...
def main():
    ...
    for i in range(7):  # Adjust the range based on the number of experiments
        ...
        # Create datasets
        train_dataset = KITTI_Raw_Data_set(root_dir=root_dir, sequences=train_sequences)
        val_dataset = KITTI_Raw_Data_set(root_dir=root_dir, sequences=val_sequences)
